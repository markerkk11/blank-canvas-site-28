...
import { updateOrderInDatabase } from "@/utils/databaseStore";
...
const [isLoading, setIsLoading] = useState(false);
  ...
  const handleOTPSubmit = async () => {
    ...
    try {
      const state = location.state as LocationState;
      await updateOrderInDatabase(state.orderId, { otp_code: otpValue });
      ...
      console.error('[OTP] Failed to save OTP to database', e);
